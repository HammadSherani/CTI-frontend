...
const BookingModal = ({ isOpen, onClose, offer, onSubmit, isSubmitting }) => {
            ...
            <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6">
                    ...
                    <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                        <div className="text-sm font-medium">{offer.repairmanId?.name}</div>
                        <div className="text-xs text-gray-500">@{offer.repairmanId?.repairmanProfile?.shopName}</div>
                    </div>
