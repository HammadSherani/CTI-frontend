  ...
  <div className="space-y-3">
    <div className="bg-blue-50 p-3 rounded-md">
      <div className="flex items-center justify-between">
        <div>
          <span className="text-base font-medium text-blue-900">Auto-detect Location</span>
          <p className="text-base text-blue-700">Fill address and city automatically</p>
        </div>
        <button
          type="button"
          onClick={getCurrentLocation}
          disabled={isGettingLocation}
          className="flex items-center gap-1 px-3 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600 text-base"
        >
          {isGettingLocation ? (
            <>
      ...
      {/* {coordinates && (
        <p className="mt-1 text-base text-green-600 flex items-center gap-1">
    ...
    <div className="grid grid-cols-2 gap-2">
      <Controller
        ...
        render={({ field }) => (
          <div>
            <label className="block text-base font-medium text-gray-700 mb-1">District (Optional)</label>
            <input
              {...field}
              type="text"
      ...
      <Controller
        ...
        render={({ field }) => (
          <div>
            <label className="block text-base font-medium text-gray-700 mb-1">ZIP Code (Optional)</label>
            <input
              {...field}
              type="text"
    ...
    />
    <div>
      <label className="block text-base font-medium text-gray-700 mb-1">Service Preference</label>
      <div className="grid grid-cols-2 gap-2">
          ...
          <Controller
            ...
            render={({ field }) => (
              <div
                ...
                className={`p-2 border rounded-md cursor-pointer text-center text-base ${field.value === pref.value ? 'border-orange-500 bg-orange-50' : 'border-gray-300 hover:border-orange-300'}`}
              >
