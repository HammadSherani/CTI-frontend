            ...
            <div className="flex items-center justify-center h-full p-8">
              <div className="text-center">
                ...
                <div className="text-white">
                  <h3 className="mb-2 text-2xl font-bold">Verify Your Account</h3>
                  <p className="text-orange-100">Almost there! Just one more step to go</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="max-w-lg mx-auto">
                  ...
                  <div className="text-center mb-8">
                    <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                      <Icon icon="mdi:email-check-outline" className="text-3xl text-orange-500" />
                    </div>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                      ...
                      />
                      {errors.otp && (
                        <p className="text-xs text-red-600 text-center mt-2">{errors.otp.message}</p>
                      )}
                    </div>
                      ...
                      {!canResend ? (
                        <div className="flex items-center justify-center gap-2 text-gray-600">
                          ...
                          <span className="text-sm">
                            Resend code in <span className="font-bold text-orange-500">{formatTime(timer)}</span>
                          </span>
                        </div>
                      ) : (
                        <button
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        <div className="flex items-center justify-center">
                          <Icon icon="mdi:check-circle-outline" className="mr-2 text-xl" />
                          Verify Account
                        </div>
                      )}
                    </button>
