...
export default function CreateFlashDealPage() {
  ...
  }, [selectedProducts, fetchProductDetails]);
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await axiosInstance.post('/admin/refurbish/flash-deals', {
        title: form.title,
      ...
      toast.error(err.response?.data?.message || "Failed to create flash deal");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen bg-gray-50/50">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Set up a new flash deal with discount and products</p>
      </div>
