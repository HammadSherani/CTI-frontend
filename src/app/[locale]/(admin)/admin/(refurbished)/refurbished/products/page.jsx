...
export default function RefurbishedProductsPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: "Stock",
      cell: (row) => {
        // Total across ALL variants (matches the variants management page's
        // total) — a single variant's stock isn't a useful "how much of this
        // product do I have" number when there's more than one variant/color.
