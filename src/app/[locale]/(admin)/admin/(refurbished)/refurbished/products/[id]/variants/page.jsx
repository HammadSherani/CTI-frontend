  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosInstance.post(
        `/admin/refurbish/products/${product._id}/variants`,
        fd,
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="text-[10px] text-gray-400 flex items-center gap-1">
                <span className="cursor-pointer hover:text-primary-500 transition-colors" onClick={() => router.push("/admin/refurbished/products")}>
                  Products
                </span>
    ...
    (async () => {
      try {
        const [prodRes, varRes] = await Promise.all([
          axiosInstance.get(`/admin/refurbish/products/${productId}`, { headers: { Authorization: `Bearer ${token}` } }),
          axiosInstance.get(`/admin/refurbish/products/${productId}/variants`, { headers: { Authorization: `Bearer ${token}` } }),
        ]);
