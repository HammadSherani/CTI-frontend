...
function EditPartsCategory() {
  ...
  const fetchCategory = async () => {
    try {
      setLoading(true);
      const response = await axiosInstance.get(`/admin/parts/parts-categories/${categoryId}`, {
        headers: {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axiosInstance.put(`/admin/parts/parts-categories/${categoryId}`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
...
export default EditPartsCategory;