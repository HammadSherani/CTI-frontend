...
function EditCity() {
  ...
  const fetchCityData = async () => {
    try {
      ...
      setValue('state', cityData.state._id || cityData.state);
      setValue('country', cityData.state.country._id || cityData.state.country);
      setValue('latitude', cityData.coordinates.latitude);
      setValue('longitude', cityData.coordinates.longitude);
  ...
  const onValid = async (data) => {
    try {
      ...
      const response = await axiosInstance.put(`/admin/cities/${cityId}`, payload, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      setSubmitSuccess('City updated successfully!');
      ...
      const errorMessage =
        error.response?.data?.message || error.message || 'Failed to update city. Please try again.';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Update city information and location details</p>
              </div>
            </div>
          </div>
        </div>
