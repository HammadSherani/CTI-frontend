...
function AddService() {
  ...
  const onSubmit = async (data) => {
    try {
      setLoading(true);
      const response = await axiosInstance.post('/repairman/services', data, {
        headers: { Authorization: `Bearer ${token}` },
      });
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Add New Service</h1>
              <p className="text-gray-600 text-lg">Create a new repair service for your catalog</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start">
              ...
              <p className="text-sm text-blue-800">
                Your service will be submitted for admin approval. Once approved, it will be visible to customers in your service catalog.
              </p>
            </div>
          </div>
        </form>
