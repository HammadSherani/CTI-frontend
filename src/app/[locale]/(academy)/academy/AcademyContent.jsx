      ...
      <section className="py-10  px-6 bg-gradient-to-b from-white to-gray-100">
        ...
        >
          <div className="md:w-1/2 mb-8 md:mb-0">
            <h1 className="text-5xl font-bold mb-4"> <span className='text-primary-400'>Integrate</span> Academy is here for you!</h1>
            <h1 className="text-3xl font-semibold mb-4 pt-2">Hundreds of training courses!</h1>
