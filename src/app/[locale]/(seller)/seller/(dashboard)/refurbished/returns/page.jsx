...
export default function SellerReturnsPage() {
  ...
  const fetchReturns = useCallback(async () => {
    ...
    try {
      ...
      const { data } = await axiosInstance.get(`/seller/refurbished-returns?${params}`, { headers });
  ...
  const handleApprove = async (returnId, adminNotes) => {
    ...
    try {
      const { data } = await axiosInstance.post("/seller/refurbished-returns/approve", { returnId, adminNotes }, { headers });
  ...
  const handleReject = async (returnId, rejectionReason) => {
    setActionLoading(true);
    try {
      await axiosInstance.post("/seller/refurbished-returns/reject", { returnId, rejectionReason }, { headers });
