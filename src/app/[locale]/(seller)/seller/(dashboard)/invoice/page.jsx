                    ...
                    <tr key={inv._id} className={`border-b border-slate-50 hover:bg-slate-50/50 transition-colors ${i % 2 === 0 ? '' : 'bg-slate-50/30'}`}>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5">
                          ...
                          <button title="Download PDF" onClick={() => downloadInvoicePDF(inv)} className="w-7 h-7 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center transition-colors">
                            <Icon icon="solar:download-minimalistic-bold-duotone" className="w-3.5 h-3.5" />
                          </button>
