    ...
    const handleDelete = async (cityId) => {
        if (window.confirm('Are you sure you want to delete this city?')) {
            try {
                ...
                setSubmitSuccess('City deleted successfully!');
                setTimeout(() => setSubmitSuccess(''), 3000);
                fetchCities();
            } catch (error) {
                console.error('Delete error:', error);
                setSubmitError('Failed to delete city. Please try again.');
                toast.error('Failed to delete city');
            }
        }
    };

    const toggleActive = async (cityId) => {
        try {
            const res = await axiosInstance.patch(`/admin/cities/${cityId}/toggle-status`, {}, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
            ...
            setSubmitError('Failed to update city status. Please try again.');
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Manage cities and their locations</p>
                        </div>
                        <Link
                            ...
                            <div className="overflow-x-auto">
                                        ...
                                        {cities.map((city) => (
                                            <tr key={city._id} className="hover:bg-gray-50">
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center">
                                                        <Icon icon="mdi:city" className="w-5 h-5 text-primary-600 mr-2" />
                                                        <div className="text-sm font-medium text-gray-900">{city.name}</div>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center">
                                                        <Icon icon="mdi:map-marker" className="w-4 h-4 text-gray-400 mr-2" />
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    >
                                                        <Icon
                                                            icon={city.isActive ? 'mdi:eye' : 'mdi:eye-off'}
                                ...
                                {!loading && cities.length === 0 && (
                                    <div className="text-center py-12">
                                        <Icon icon="mdi:city" className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                                <Icon icon="mdi:city" className="w-8 h-8 text-primary-600" />
                            </div>
                            <div className="ml-4">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-semibold text-gray-900">
                                    {loading ? '...' : cities.filter(c => c.isActive).length}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-500">Inactive Cities</p>
                                <p className="text-2xl font-semibold text-gray-900">
                                    {loading ? '...' : cities.filter(c => !c.isActive).length}
                                </p>
                            </div>
