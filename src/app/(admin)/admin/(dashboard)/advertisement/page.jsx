                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Monitor and manage all repair Ads</p>
                        </div>
                        <Link
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-500">Request Ads</p>
                                <p className="text-2xl font-semibold text-gray-900">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-500">In Pending</p>
                                <p className="text-2xl font-semibold text-gray-900">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-500">Approved Ads</p>
                                <p className="text-2xl font-semibold text-gray-900">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="booked">Reject</option>
