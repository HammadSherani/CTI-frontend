...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-100 py-12 px-2">
      <div className="max-w-7x mx-auto px-2 ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-gray-600 hover:bg-primary-500 rounded-full flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {services.map((service, index) => (
                <li key={index}>
                  <a href="#" className="text-gray-700 hover:text-primary-500 transition-colors text-sm">
                    {service}
                  </a>
                </li>
              ))}
          ...
          {/* Sell Device */}
          <div>
            <h3 className="font-bold text-gray-900 mb-4 text-lg">Sell Device</h3>
            <ul className="space-y-2">
              {sellDevice.map((device, index) => (
                <li key={index}>
                  <a href="#" className="text-gray-700 hover:text-primary-500 transition-colors text-sm">
                    {device}
                  </a>
          ...
          {/* Help & Support */}
          <div>
            <h3 className="font-bold text-gray-900 mb-4 text-lg">Help & Support</h3>
            <ul className="space-y-2">
          ...
          {/* More Info */}
          <div>
            <h3 className="font-bold text-gray-900 mb-4 text-lg">More Info</h3>
            <ul className="space-y-2">
              {moreInfo.map((info, index) => (
               ...
               {/* Chat Button */}
        <div className="mt-10">
          <button className="bg-gradient-to-br from-primary-400 to-primary-500 text-white py-2 px-1 w-full rounded-2xl shadow-lg hover:shadow-xl transition-all flex items-center gap-3 group">
            <Icon icon="mdi:chat" className="text-2xl" />
            <div className="text-left">
              <div className="font-bold">Chat with Us</div>
              <div className="text-sm opacity-90">Got questions? Just ask.</div>
            </div>
          </button>
        </div>
          </div>
