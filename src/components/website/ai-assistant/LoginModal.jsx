  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (resData?.user?.role !== "customer") {
        setErrorMessage("Only customers can use the shopping assistant.");
        return;
      }
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              animate={{ opacity: 1, rotate: 0, transition: { delay: 0.6, duration: 0.3 } }}
            >
                ...
                <div className="flex items-center justify-center h-full p-8 relative z-10">
                  <div className="text-center">
                    <motion.div
                      ...
                      animate={{ opacity: 1, scale: 1, transition: { delay: 0.4, duration: 0.5, type: "spring", stiffness: 200 } }}
                    >
                      <Image
                    ...
                    <div className="text-white">
                      ...
                      >
                        Sign in to save and manage your chat conversations
                      </motion.p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="w-full max-w-sm">
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm">Sign in to save your assistant chat</p>
                  </motion.div>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <div className="relative">
                            ...
                            />
                            <Icon icon="mdi:email-outline" className="absolute left-3 top-3 text-gray-400 text-lg" />
                          </div>
                        )}
                      />
                      {errors.email && (
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <div className="relative">
                            ...
                            />
                            <Icon icon="mdi:lock-outline" className="absolute left-3 top-3 text-gray-400 text-lg" />
                            <button
                              type="button"
                    ...
                    {/* Remember Me */}
                    <motion.div className="flex items-center justify-between" custom={3} variants={formItemVariants} initial="hidden" animate="visible">
                      <Controller
                        name="rememberMe"
                        control={control}
                        render={({ field }) => (
                          <label className="flex items-center cursor-pointer">
                            ...
                            <div className={`w-4 h-4 border-2 rounded flex items-center justify-center transition-all duration-200 ${field.value ? 'bg-orange-500 border-orange-500' : 'border-gray-300 hover:border-orange-300'}`}>
                              {field.value && <Icon icon="mdi:check" className="text-white text-xs" />}
                            </div>
                    ...
                    <motion.button
                      ...
                      className="w-full py-3 font-bold text-white bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg shadow-lg hover:from-orange-600 hover:to-orange-700 transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50"
                      custom={4}
                      variants={formItemVariants}
                      initial="hidden"
                      animate="visible"
                  ...
                  {/* Sign Up Link */}
                  <motion.div className="mt-6 text-center" custom={5} variants={formItemVariants} initial="hidden" animate="visible">
                    <span className="text-gray-600 text-sm">Don't have an account? </span>
                    <Link href={"/auth/register"} className="font-bold text-orange-500 hover:text-orange-600 transition-colors text-sm">
                      Create Account
                    </Link>
                  </motion.div>
                </div>
